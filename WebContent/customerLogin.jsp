...
<body background="images/BackgroundImage1.jpg">
	<div class="wrapper">
		<div>
			<img src="images/customerLoginBanner.jpg" width="1026px" height="340px"
				alt="">
		</div>
		...
		<div class="contentliquid">
			<div class="left">
				...
				<h4 style="color:Green">If you are not Registered, 
					<a href="signUp.jsp" style="text-decoration: none !important; color:Green;">Sign Up</a> First
				</h4><hr/>
				<h3 style="color:Green">${requestScope['msg']}</h3>
				
					<jsp:useBean id="cust" class="bean.Customer"></jsp:useBean>
					<table style=" color: #2165bc; margin-left: 20px; font-face: bold; 
											font-family: arial" cellpadding="5">
						<tr><td >
						<c:forEach items="${cust.allUid}" var="cust">
							Note Your ID : ${cust.uid} , Must Remember your Password.
						</c:forEach>
  	...
  	<table style="margin-left: 20px; font-face: bold; font-family: arial" cellpadding="5">
  	 <tr>
  	   	 <td>Customer ID : </td><td><input type="text" name="uid" class="tb10"></td>
  	 </tr>
  	 <tr>
  	   	 <td>Password : </td><td><input type="password" name="upassword" class="tb10"></td>
  	 </tr>
  	 <tr>
  	 	<td><input type="submit" name="btnCustomerlogin" value="Log In" class="testbutton"></td>
  	 </tr>  	
  	</table>
  </form>
	</div>
